/**
 * staffAdmin.js —— 由 views/admin-pages/staffAdmin.jade 提取。
 * 懒加载：用户切换到「staff-admin」页时由 loader.js 动态拉取。
...
const StaffAdminPage = () => {
    ...
    }, [selectedOrganize, keyword, page, pageSize]);
    ...
    const handleSelectOrganize = (id) => {
      setSelectedOrganize(id || null);
      setPage(1);
    };
  ...
  window.AdminPages['staff-admin'] = StaffAdminPage;
})();
