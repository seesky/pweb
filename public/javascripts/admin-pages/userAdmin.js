/**
 * userAdmin.js —— 由 views/admin-pages/userAdmin.jade 提取。
 * 懒加载：用户切换到「user-admin」页时由 loader.js 动态拉取。
...
const UserAdminPage = () => {
  ...
  window.AdminPages['user-admin'] = UserAdminPage;
})();
