/**
 * relayAdmin.js —— 由 views/admin-pages/relayAdmin.jade 提取。
 * 懒加载：用户切换到「relay-admin」页时由 loader.js 动态拉取。
...
// ===== TURN/中继节点管理（平台超管） =====
  ...
  window.AdminPages['relay-admin'] = RelayAdminPage;
})();
